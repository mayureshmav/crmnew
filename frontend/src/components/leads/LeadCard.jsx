...
<div className="bg-white rounded-xl shadow-md hover:shadow-lg transition flex flex-col h-full p-5">
...
<span>{lead.assignedRep || "Unassigned"}</span>
...
whileTap={{scale:.95}}
className="mt-5 w-full flex items-center justify-center gap-2 text-sm py-2 rounded-lg text-white font-medium bg-gradient-to-r from-indigo-600 to-blue-600 shadow-sm hover:shadow-md transition"
>
